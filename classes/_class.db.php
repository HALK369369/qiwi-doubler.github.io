...
class db{
	...
	public function __construct($host, $user, $password, $base){
		$this->Connect($host, $user, $password, $base);
	...
	\*======================================================================*/	
	private function Connect($host, $user, $password, $base){
		$this->con =  @mysqli_connect($host, $user, $password, $base) or $this->GetError(mysqli_connect_error());
	} 
